...
user_char_tags_raw = load_json('anime_character_guessr/tags.character_tags.json')
...
save_json(bgm2attr, 'anime_character_guessr/id_tags.json')

with open("anime_character_guessr/id_tags.js", "w", encoding='utf-8') as f:
