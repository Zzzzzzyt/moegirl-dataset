...
chars: set[str] = set(load_json('moegirl/char_index.json'))
subjects: dict = load_json('moegirl/subjects.json')
...
save_json(char2subject, 'moegirl/char2subject.json')
...
save_json(subject_index, 'moegirl/subject_index.json')
