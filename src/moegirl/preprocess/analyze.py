...
char_index: list[str] = json.load(open('moegirl/char_index.json', encoding='utf-8'))
attr_index: list[str] = json.load(open('moegirl/attr_index.json', encoding='utf-8'))
attr2char: dict[str, list[str]] = json.load(open('moegirl/attr2char.json', encoding='utf-8'))
char2attr: dict[str, list[str]] = json.load(open('moegirl/char2attr.json', encoding='utf-8'))
