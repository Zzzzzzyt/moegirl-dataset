...
attrs = load_json('moegirl/attr_index.json')
chars = load_json('moegirl/char_index.json')
P = np.load(open('moegirl/analysis/intersection.npy', 'rb'))
gain = np.load(open('moegirl/analysis/gain.npy', 'rb'))
chi2 = np.load(open('moegirl/analysis/chi2.npy', 'rb'))
...
hair_color_attr = load_json('moegirl/hair_color_attr.json')
# hair_color_attr.sort(key=lambda x: P[attrmap[x]][attrmap[x]], reverse=True)
eye_color_attr = load_json('moegirl/eye_color_attr.json')
...
# subset = load_json('moegirl/subset/blue_archive_subset.json')
