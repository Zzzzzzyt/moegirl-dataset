...
male_attr = set(load_json('moegirl/male_attr.json'))
female_attr = set(load_json('moegirl/female_attr.json'))
nogender_attr = set(load_json('moegirl/nogender_attr.json'))
...
save_json(gender, 'moegirl/char2gender.json')
