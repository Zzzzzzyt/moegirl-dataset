...
chars: dict = {}
with open("bangumi/dump/character.jsonlines", "r", encoding="utf-8") as f:
    for line in f:
...
subjects = {}
char2subjects = {}
with open("bangumi/dump/subject.jsonlines", "r", encoding='utf8') as f:
    for line in f:
...
with open("bangumi/dump/subject-characters.jsonlines", "r", encoding='utf8') as f:
    for line in f:
