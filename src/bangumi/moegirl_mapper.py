...
special_map = {
    ...
    '78102': '芙列雅·艾尔格兰帝·吉欧拉尔',
    '36560': '芙蕾雅·薇恩',
    '31247': '芙蕾雅(在地下城寻求邂逅是否搞错了什么)',
    '14822': '折木奉太郎',
    '3214': '卫宫士郎',
    '51': '古泉一树',
    '18574': '乔尼·乔斯达',
...
moegirl_chars = load_json("moegirl/char_index.json")
print("loaded: moegirl_chars:", len(moegirl_chars))
moegirl_extra = load_json("moegirl/extra_processed.json")
print("loaded: moegirl_extra:", len(moegirl_extra))
char2subject = load_json("moegirl/char2subject.json")
